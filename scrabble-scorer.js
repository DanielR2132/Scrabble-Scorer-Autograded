...
function initialPrompt() {
   ...
   while(containsSpecialChars(word) || containsNumber(word)){
...
function scorerPrompt() {
   ...
   while(scoringOption.match(/[A-Za-z]/) || scoringOption < 0 || scoringOption > 2 || containsSpecialChars(scoringOption)){
